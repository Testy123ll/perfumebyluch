...
const faqCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Boxed and Tester perfumes are brand new, sealed, unused and cost more, whereas, unboxed and thrifted open box perfumes aren’t sealed, whereas, the Unboxed and Thrifted Open Box perfumes aren’t new or sealed and may not come full, bottles may not be neat, and may also have slight dents or scratches, but this doesn’t in anyway affect the authenticity of the products. Although, performance may not be the same for Boxed and Unboxed in some cases due to shelf life.",
      },
      {
